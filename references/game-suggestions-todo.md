...
|---|---|---|---|---|---|
| 2026-06-29 | Ciclos de Luz | `ciclos-luz` | VERSUS | sugerido | VERSUS solo tiene Pong; mecánica de rastros neón única y estéticamente ideal |
| 2026-06-29 | Batalla de Tanques | `tanques` | VERSUS | sugerido | Segundo juego VERSUS; rotación top-down y rebote de proyectiles, distinto a Pong |
| 2026-06-29 | Sokoban | `sokoban` | PUZZLE | sugerido | PUZZLE tiene dos clones de Tetris; Sokoban aporta razonamiento espacial puro sin tiempo real |
